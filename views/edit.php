<div class="uk-grid uk-grid-divider uk-form uk-form-horizontal" data-uk-grid-margin>
    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content-map" class="uk-switcher">
            <li>
              <div class="uk-alert">
                OBS ANDRE:: È NECESSÁRIO JOGAR O ARQUIVO DA PASTA LIB DENTRO DA PASTA LIBRARIE DO JOOMLA, PARA AS ROTAS FUNCIONAREM, E SETAR O LAYOUT
                <pre>
                  <code>
                    ///php layout
                    JLoader::register('Ferramentas', JPATH_LIBRARIES . '/Ferramentas.php');

                    Ferramentas::GetJsfile('HEAD');
                  </code>
                </pre>
              </div>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-height">Load Callback</label>
                    <div class="uk-form-controls">

                      <select id="wk-callback" class="uk-form-width-medium" ng-model="widget.data['callback']">
